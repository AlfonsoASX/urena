...
<head>
    ...
    @vite(['resources/scss/layouts/horizontal-light-menu/dark/loader.scss'])
    ...
    @vite(['resources/scss/layouts/horizontal-light-menu/light/structure.scss'])
    @vite(['resources/scss/layouts/horizontal-light-menu/dark/structure.scss'])
