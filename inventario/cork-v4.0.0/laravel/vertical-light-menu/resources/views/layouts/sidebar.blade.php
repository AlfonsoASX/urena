    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ ($catName === 'app') ? 'active' : '' }}">
                <a href="#apps" data-bs-toggle="collapse" aria-expanded="{{ ($catName === 'app') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled {{ ($catName === 'app') ? 'show' : '' }}" id="apps" data-bs-parent="#accordionExample">
