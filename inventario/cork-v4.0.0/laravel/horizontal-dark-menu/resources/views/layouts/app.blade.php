...
<head>
    ...
    @vite(['resources/scss/layouts/horizontal-dark-menu/light/loader.scss'])
    @vite(['resources/scss/layouts/horizontal-dark-menu/dark/loader.scss'])
    ...
    @vite(['resources/scss/layouts/horizontal-dark-menu/light/structure.scss'])
    @vite(['resources/scss/layouts/horizontal-dark-menu/dark/structure.scss'])
