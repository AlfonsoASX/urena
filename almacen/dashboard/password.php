        ...
        <div class="col-lg-6 col-sm-10 text-center ">
            ...
            <form class="" action="password.php" method="POST" onsubmit="return validacion()">
                ...
                <div class="form-inline pt-3 mr-4 float-right ">
                    ...
                    <input type="password" class="form-control" style="width: 300px;"  placeholder="" id="pass_ant" name="pass_ant" required pattern="[\S]+" title="No se admiten espacios en blanco">
                ...
                <div class="form-inline pt-3 mr-4 float-right ">
                    ...
                    <input type="password" minlength="6" class="form-control" style="width: 300px;"  placeholder="" id="pass_new" name="pass_new" required pattern="[\S]+" title="No se admiten espacios en blanco">
                    <span class="input-group-btn">
                ...
                <div class="form-inline pt-3 mr-4 float-right ">
                    ...
                    <input type="password" minlength="6" class="form-control" style="width: 300px;"  placeholder="" id="conf_pass" name="conf_pass" required pattern="[\S]+" title="No se admiten espacios en blanco">
                    <span class="input-group-btn">
